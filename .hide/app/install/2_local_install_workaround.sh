...
if [ -d ~/Library/Screen\ Savers/$screen_saver ] ; then
  ...
  defaults -currentHost write com.apple.screensaver moduleDict -dict moduleName $saver path /Library/Screen\ Savers/$screen_saver type 0
